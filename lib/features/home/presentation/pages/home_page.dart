...
import 'package:data_caching/features/home/presentation/blocs/home_blocs/product_status.dart';
import 'package:data_caching/features/home/presentation/widgets/home_single_list_item.dart';
          ...
          child: BlocConsumer<HomeBloc, HomeState>(
            ...
            builder: (context, state) {
              ...
              if (state.homeProductStatus is HomeProductStatusError) {
                // downcasting to access the error message
              ...
              // completed state
              if (state.homeProductStatus is HomeProductStatusCompleted) {
                // downcasting to access the products
                ...
                return LiquidPullToRefresh(
                  ...
                  // call the event to refresh the products list
                  onRefresh: () async {
